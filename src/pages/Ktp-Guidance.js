    ...
    >
      <Box px="5%">
        <Box display="flex" alignItems="center" gap={0.5} pt={1} mb={2.5}>
          ...
          <Text sx={{ fontSize: "1rem", fontWeight: 300 }}>Foto KTP</Text>
        </Box>

        <Box display="flex" justifyContent="center" mb={2}>
          <img src={"/image/ktp-placeholder.png"} alt="vector" width="60%" />
        </Box>
        ...
        <Card variant="outlined">
          <CardContent sx={{ p: 2, px: 4, pb: "10px !important" }}>
            ...
            >
              {[
                "Pastikan foto KTP berada di dalam bingkai dan tidak terpotong.",
                "Pastikan foto KTP terlihat terang & jelas.",
                "KTP masih berlaku.",
                "Gunakan KTP asli, bukan fotokopi.",
              ].map((item, index) => (
...
export default connect(mapStateToProps, mapDispatchToProps)(KtpGuidance);
